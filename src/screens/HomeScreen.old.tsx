    ...
    datasets: [
      {
        ...
        color: () => COLORS.chartGold1,
        strokeWidth: 2,
      },
      {
        data: [50, 60, 55, 70, 65, 75],
        color: () => COLORS.chartGold2,
        strokeWidth: 2,
      },
      {
        data: [40, 50, 45, 60, 55, 65],
        color: () => COLORS.chartGold3,
        strokeWidth: 2,
      },
    ],
  };
      ...
      <Card style={styles.chartCard}>
        ...
        <View style={styles.chartLegend}>
          <View style={styles.legendItem}>
            <View style={[styles.legendDot, { backgroundColor: COLORS.chartGold1 }]} />
            <Text style={styles.legendText}>Inflows</Text>
          </View>
          <View style={styles.legendItem}>
            <View style={[styles.legendDot, { backgroundColor: COLORS.chartGold2 }]} />
            <Text style={styles.legendText}>Outflows</Text>
          </View>
          <View style={styles.legendItem}>
            <View style={[styles.legendDot, { backgroundColor: COLORS.chartGold3 }]} />
